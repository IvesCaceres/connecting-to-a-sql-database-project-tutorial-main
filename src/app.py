...
def connect():
    ...
    #connection_string = f"postgresql://{username}:{password}@host:5432/master"
...
# Define tus consultas SQL como objetos text
...
# Define una lista de consultas SQL
...
dataf = pd.read_sql_query("SELECT * FROM publishers;", engine)
print('ACA ESTA EL DATAFRAME', dataf)